 ...
 */
export const encrypt = (str: string, key_src = _random(256, 9).alphaNumSpecial(true), salt = _random(128, 9).alphaNum(true)): DecryptInfo => {
 ...
 */
export const decrypt = (options: DecryptInfo) => {
